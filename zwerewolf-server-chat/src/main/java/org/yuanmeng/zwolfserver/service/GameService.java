...
import org.yuanmeng.zwolfserver.metadata.business.GameInfo;
import org.yuanmeng.zwolfserver.metadata.business.GlobalData;
...
public class GameService {
    ...
    public Room checkAndGetRoom(int roomId, int owner) {
        ...
        Room room = RoomChannelTable.getRoom(roomId);
